...
- Add `buildMarkers(config, root, intervals, displayMode)`, a shared function for turning a root + interval set into fretboard `Marker[]`, reused later by the arpeggio tool
